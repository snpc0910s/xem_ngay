...
namespace Xem_Ngay.model._64que
{
    ...
    {
        // noi quai CÀN
        public static readonly Que THUAN_CAN = new Que("Càn vi Thiên", BatQuaiInstance.CAN, BatQuaiInstance.CAN).setQuaiVan(1);
        ...
        public static readonly Que DIA_THIEN_THAI = new Que("Địa Thiên Thái", BatQuaiInstance.KHON, BatQuaiInstance.CAN).setQuaiVan(9);

        // noi quai ĐOÀI
        public static readonly Que THIEN_TRACH_LY = new Que("Thiên Trạch Lý", BatQuaiInstance.CAN, BatQuaiInstance.DOAI).setQuaiVan(6);
        public static readonly Que THUAN_DOAI = new Que("Đoài vi Trạch", BatQuaiInstance.DOAI, BatQuaiInstance.DOAI).setQuaiVan(1);
        ...
        public static readonly Que SON_TRACH_TON = new Que("Sơn Trạch Tổn", BatQuaiInstance.CANAS, BatQuaiInstance.DOAI).setQuaiVan(9);
        ...
        public static readonly Que THUAN_LY = new Que("Ly vi Hoả", BatQuaiInstance.LY, BatQuaiInstance.LY).setQuaiVan(1);
        ...
        public static readonly Que THUY_HOA_KY_TE = new Que("Thuỷ Hoả Ký Tế", BatQuaiInstance.KHAM, BatQuaiInstance.LY).setQuaiVan(9);
        ...
        public static readonly Que THUAN_CHAN = new Que("Chấn vi Lôi", BatQuaiInstance.CHAN, BatQuaiInstance.CHAN).setQuaiVan(1);
        public static readonly Que PHONG_LOI_ICH = new Que("Phong Lôi Ích", BatQuaiInstance.TON, BatQuaiInstance.CHAN).setQuaiVan(9);
        ...
        public static readonly Que LOI_PHONG_HANG = new Que("Lôi Phong Hằng", BatQuaiInstance.CHAN, BatQuaiInstance.TON).setQuaiVan(9);
        public static readonly Que THUAN_TON = new Que("Tốn vi Phong", BatQuaiInstance.TON, BatQuaiInstance.TON).setQuaiVan(1);
        ...
        public static readonly Que HOA_THUY_VI_TE = new Que("Hoả Thuỷ Vị Tế", BatQuaiInstance.LY, BatQuaiInstance.KHAM).setQuaiVan(9);
        ...
        public static readonly Que THUAN_KHAM = new Que("Khảm vi Thuỷ", BatQuaiInstance.KHAM, BatQuaiInstance.KHAM).setQuaiVan(1);
        ...
        public static readonly Que TRACH_SON_HAM = new Que("Trạch Sơn Hàm", BatQuaiInstance.DOAI, BatQuaiInstance.CANAS).setQuaiVan(9);
        ...
        public static readonly Que THUAN_CANAS = new Que("Cấn vi Sơn", BatQuaiInstance.CANAS, BatQuaiInstance.CANAS).setQuaiVan(1);
        public static readonly Que DIA_SON_KHIEM = new Que("Địa Sơn Khiêm", BatQuaiInstance.KHON, BatQuaiInstance.CANAS).setQuaiVan(6);

        // noi quai KHÔN
        public static readonly Que THIEN_DIA_BI = new Que("Thiên Địa Bĩ", BatQuaiInstance.CAN, BatQuaiInstance.KHON).setQuaiVan(9);
        ...
        public static readonly Que THUAN_KHON = new Que("Khôn vi Địa", BatQuaiInstance.KHON, BatQuaiInstance.KHON).setQuaiVan(1);
